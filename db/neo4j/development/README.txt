...
Welcome to Neo4j release 2.1.4, a high-performance graph database.
...
For full instructions, see http://neo4j.com/docs/2.1.4/deployment/
...
* Getting Started: http://neo4j.com/docs/2.1.4/introduction/
* The Neo4j Manual: http://neo4j.com/docs/2.1.4/
